...
import pl.bartol0220.stls.model.vehicles.Ambulance;
...
class EmergencyVehiclesLightControllerTest {
    @Test
    void controllerWorksWithNoEmergency1() throws EmptyLightPhases, InvalidTrafficLaneDirectionException, IllegalVehicleDestination {
        ...
        AbstractLightController lightController = new EmergencyVehiclesLightController(new VehiclesPriorityLightController(intersection));
    ...
    @Test
    void controllerWorksWithNoEmergency2() throws EmptyLightPhases, InvalidTrafficLaneDirectionException, IllegalVehicleDestination {
        Intersection intersection = new Intersection();
        ...
        AbstractLightController lightController = new EmergencyVehiclesLightController(new VehiclesPriorityLightController(intersection, 2));
        Simulation simulation = prepareSimulation(intersection, lightController);
    ...
    @Test
    void controllerWorksWithNoEmergency3() throws EmptyLightPhases, InvalidTrafficLaneDirectionException, IllegalVehicleDestination {
        Intersection intersection = new Intersection();
        ...
        AbstractLightController lightController = new EmergencyVehiclesLightController(new VehiclesPriorityLightController(intersection, 10));
        Simulation simulation = prepareSimulation(intersection, lightController);
    ...
    @Test
    void controllerWorksWithEmergencyVehicle() throws EmptyLightPhases, InvalidTrafficLaneDirectionException, IllegalVehicleDestination {
        Intersection intersection = new Intersection();
        ...
        Vehicle ambulance = new Ambulance("ambulance1", RoadsDirection.WEST, RoadsDirection.EAST);
        simulation.addVehicle(ambulance);

        List<Vehicle> leftVehicles = simulation.step();

        assertEquals(1, leftVehicles.size());
        assertEquals(ambulance, leftVehicles.getFirst());
    }

    @Test
    void controllerWorksWithCarsBeforeAmbulance() throws EmptyLightPhases, InvalidTrafficLaneDirectionException, IllegalVehicleDestination {
        Intersection intersection = new Intersection();
        ...
        vehicle = new Car("3", RoadsDirection.SOUTH, RoadsDirection.NORTH);
        simulation.addVehicle(vehicle);
        vehicle = new Car("4", RoadsDirection.SOUTH, RoadsDirection.NORTH);
        simulation.addVehicle(vehicle);


        Vehicle vehicle5 = new Car("5", RoadsDirection.WEST, RoadsDirection.EAST);
        simulation.addVehicle(vehicle5);
        Vehicle vehicle6 = new Car("6", RoadsDirection.WEST, RoadsDirection.EAST);
        simulation.addVehicle(vehicle6);
        ...
        List<Vehicle> leftVehicles = simulation.step();
        assertEquals(1, leftVehicles.size());
        assertEquals(vehicle5, leftVehicles.getFirst());

        leftVehicles = simulation.step();
        assertEquals(1, leftVehicles.size());
        assertEquals(vehicle6, leftVehicles.getFirst());
